...
function executar(){
    ...
    saida.innerHTML = ''
    saida.innerHTML += `<p style="font-size: 23px; font-weight: bold;">Analisando a situação de ${nome}</p>`
    saida.innerHTML += `<p>Com as notas ${nota1} e ${nota2}, a média é ${media}</p>`
    if (media < 3) {
      saida.innerHTML += `<p>Com média abaixo de 3.0 o aluno está <strong>REPROVADO</strong></p>`
      let strong = document.querySelector('strong')
      strong.style.backgroundColor = '#E28783'
    } else if (media < 6) {
      saida.innerHTML += `<p>Com média entre 3.0 e 6.0 o aluno está <strong>RECUPERAÇÃO</strong></p>`
      let strong = document.querySelector('strong')
      strong.style.backgroundColor = '#FFFFE3'
    } else {
      saida.innerHTML += `<p>
        <Com média acima de 6.0 o aluno está <strong>APROVADO</strong>
      </p>`
      let strong = document.querySelector('strong')
      strong.style.backgroundColor = '#A6EB9A'
    }
} 